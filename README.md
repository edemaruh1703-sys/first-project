...
Для добавления датчиков на мониторинг необходимо найти датчик в древовидной структуре или через поиск, зажать его левой или правой кнопкой мыши, перетащить его на любую ячейку и освободить кнопку мыши. Откроется окно с выбором типа графика:
...
![Рис. 3](https://github.com/edemaruh1703-sys/first-project/blob/main/Screenshot_4.png?raw=true)
...
| :---------------: | :----------------------: | :----------------------: |
|   **Линия**          |    Главное<br> Масштаб<br>Сетка<br> Датчики                |  Имя, наложение линий<br> Вертик./горизонт. масштаб<br> Линии/текст сетки<br> Цвет/порядок датчиков   |
